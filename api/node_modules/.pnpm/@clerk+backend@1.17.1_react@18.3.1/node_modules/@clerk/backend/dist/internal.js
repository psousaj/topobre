...
__export(internal_exports, {
  ...
  __experimental_reverificationError: () => import_authorization_errors.__experimental_reverificationError,
  __experimental_reverificationErrorResponse: () => import_authorization_errors.__experimental_reverificationErrorResponse,
  constants: () => constants,
...
var API_VERSION = "v1";
var USER_AGENT = `${"@clerk/backend"}@${"1.17.1"}`;
var MAX_CACHE_LAST_UPDATED_AT_SECONDS = 5 * 60;
var JWKS_CACHE_TTL_MS = 1e3 * 60 * 60;
var SUPPORTED_BAPI_VERSION = "2021-02-05";
var Attributes = {
...
function signedInAuthObject(authenticateContext, sessionToken, sessionClaims) {
  ...
  return {
    ...
    getToken,
    has: (0, import_authorization.createCheckAuthorization)({ orgId, orgRole, orgPermissions, userId, __experimental_factorVerificationAge }),
